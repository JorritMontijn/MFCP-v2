...
function [intPressed,intPressCount,structVals] = GetLeverLeftFPGA(objCard,sPortDef,structVals,boolReset)
	%define boolReset
	...
	structVals = ReadFPGA(objCard,sPortDef.ADRES_PEDAALLINKS,boolReset,structVals,sPortDef);
	
	intActiveBits = structVals.SENSOR0;
	intPressed = ~bitget(intActiveBits,sPortDef.ADRES_PEDAALLINKS+1);
