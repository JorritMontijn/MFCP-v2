function msgID = MFCP_queryReadFPGA(sMS,xem,intBitNr,boolReset)
	%MFCP_queryReadFPGA Asynchronous ReadFPGA function to send a request to
	%the master for the structVals of the specified bit-number. Returns the
	%msgID that you can use with MFCP_getReadFPGA() to retrieve the answer.
	%   Syntax:
