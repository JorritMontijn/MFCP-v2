...
function [intPressed,intPressCount,structVals] = GetLeverRightFPGA(objCard,sPortDef,structVals,boolReset)
	%define boolReset
	...
	structVals = ReadFPGA(objCard,sPortDef.ADRES_PEDAALRECHTS,boolReset,structVals,sPortDef);
	
	intActiveBits = structVals.SENSOR0;
	intPressed = ~bitget(intActiveBits,sPortDef.ADRES_PEDAALRECHTS+1);
